webapp.pages.Accounting_Vendors_Quote_New =
	{
		...
		pageInit : function ()
		{
			var me = webapp.pages.Accounting_Vendors_Quote_New;
		...
		{ 
			...
			webapp.queryServer ("accounting::vendors::quote::add", szParams, function (objJSON)
			{ 
				var nID = objJSON.return;
				
				webapp.showPage ("Accounting_Vendors_Quote_New2", nID); 
			});
		},
