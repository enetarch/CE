webapp.pages.Accounting_Vendors_Quote_Edit =
	{
		...
		pageInit : function ()
		{
			var me = webapp.pages.Accounting_Vendors_Quote_Edit;
		...
		{ 
			...
			webapp.queryServer ("accounting::vendors::quote::update", szParams, function (objJSON)
			{ 
				var nID = objJSON.return;
				
				webapp.showPage ("Accounting_Vendors_Quote_Edit2", nID); 
			});
		},
