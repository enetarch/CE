webapp.pages.Accounting_Vendors_Fees_Home =
{
	buttons : 
	{
		 ...
		 { 
				var me = webapp.pages.Accounting_Vendors_Fees_Home;
		...
		button_AddItem : function () { webapp.showPage ("Accounting_Vendors_Fee_New"); },
	...
	list : 
		{
			...
			row :
			{
				...
				buttons : 
				{ 
					fee_viewmore :  function (nID) 
					{ webapp.showPage ("Accounting_Vendors_Fee_View", nID);}, 
				},
				get_Data : "accounting::vendors::fees::list",
			},
