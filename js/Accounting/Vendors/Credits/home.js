webapp.pages.Accounting_Vendors_Credits_Home =
{
	buttons : 
	{
		 ...
		 { 
				var me = webapp.pages.Accounting_Vendors_Credits_Home;
		...
		button_AddItem : function () { webapp.showPage ("Accounting_Vendors_Credit_New"); },
	...
	list : 
		{
			...
			row :
			{
				...
				buttons : 
				{ 
					credit_viewmore :  function (nID) 
					{ webapp.showPage ("Accounting_Vendors_Credit_View", nID);}, 
				},
				get_Data : "accounting::vendors::credits::list",
			},
