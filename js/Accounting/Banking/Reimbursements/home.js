webapp.pages.Accounting_Banking_Reimbursements_Home =
{
	buttons : 
	{
		 ...
		 { 
				var me = webapp.pages.Accounting_Banking_Reimbursements_Home;
		...
		button_AddItem : function () { webapp.showPage ("Accounting_Banking_Reimbursement_New"); },
	...
	list : 
		{
			...
			row :
			{
				...
				{ 
					...
					{ webapp.showPage ("Accounting_Banking_Reimbursement_View", nID);}, 
				},
				get_Data : "accounting::banking::reimbursements::list",
			},
