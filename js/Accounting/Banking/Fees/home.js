webapp.pages.Accounting_Banking_Fees_Home =
{
	buttons : 
	{
		 ...
		 { 
				var me = webapp.pages.Accounting_Banking_Fees_Home;
		...
		button_AddItem : function () { webapp.showPage ("Accounting_Banking_Fee_New"); },
	...
	list : 
		{
			...
			row :
			{
				...
				{ 
					...
					{ webapp.showPage ("Accounting_Banking_Fee_View", nID);}, 
				},
				get_Data : "accounting::banking::fees::list",
			},
