webapp.pages.Accounting_Banking_Checks_Home =
{
	buttons : 
	{
		 ...
		 { 
				var me = webapp.pages.Accounting_Banking_Checks_Home;
		...
		button_AddItem : function () { webapp.showPage ("Accounting_Banking_Check_New"); },
	...
	list : 
		{
			...
			row :
			{
				...
				{ 
					...
					{ webapp.showPage ("Accounting_Banking_Check_View", nID);}, 
				},
				get_Data : "accounting::banking::checks::list",
			},
