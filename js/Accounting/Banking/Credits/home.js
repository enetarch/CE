webapp.pages.Accounting_Banking_Credits_Home =
{
	buttons : 
	{
		 ...
		 { 
				var me = webapp.pages.Accounting_Banking_Credits_Home;
		...
		button_AddItem : function () { webapp.showPage ("Accounting_Banking_Credit_New"); },
	...
	list : 
		{
			...
			row :
			{
				...
				{ 
					...
					{ webapp.showPage ("Accounting_Banking_Credit_View", nID);}, 
				},
				get_Data : "accounting::banking::credits::list",
			},
