webapp.pages.Accounting_Clients_Reimbursement_New =
{
	btn_Back : "titlebar_back",
	btn_Exit : "titlebar_exit",
	
	get_Item :  "accounting::client::reimbursement::get",
	
	
	pageInit : function ()
	{
		var me = webapp.pages.Accounting_Clients_Reimbursement_New;
	...
	{ 
		...
		webapp.queryServer (me.get_Item, szParam, me.draw_Client);
	},
