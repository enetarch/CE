webapp.pages.Accounting_Clients_Invoices_List =
{
	szPageURL : "Accounting_Clients_Invoices_List",
	...
	template_List : "invoice_list_row_template", 
	tblList : "invoice_list",
	get_List :  "accounting::clients::invoice::list",
	btn_view : "invoice_viewmore",

	btn_AddItem : "button_AddItem",
	btn_SortInvoiceNo : "button_SortInvoiceNo",
	...
	pageInit : function ()
	{
		var me = webapp.pages.Accounting_Clients_Invoices_List;
	...
	cmdAddItem : function ()
	{ webapp.showPage ("Accounting_Clients_Invoice_New"); },
	...
	{	webapp.showPage ("Accounting_Clients_Invoice_View", nID); }
};
