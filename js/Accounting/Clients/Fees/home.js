webapp.pages.Accounting_Clients_Fees_Home =
{
	...
	template_List : "fees_list_row_template", 
	tblList : "fees_list",
	get_List :  "accounting::clients::fees::list",
	...
	pageInit : function ()
	{
		var me = webapp.pages.Accounting_Clients_Fees_Home;
	...
	cmdAddItem : function ()
	{ webapp.showPage ("Accounting_Clients_Fee_New"); },
	...
	{	webapp.showPage ("Accounting_Clients_Fee_View", nID); }
};
