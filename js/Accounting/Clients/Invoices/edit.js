webapp.pages.Accounting_Clients_Invoice_Edit =
	{
		...
		pageInit : function ()
		{
			var me = webapp.pages.Accounting_Clients_Invoice_Edit;
		...
		{ 
			...
			webapp.queryServer ("accounting::clients::invoice::update", szParams, function (objJSON)
			{ 
				var nID = objJSON.return;
				
				webapp.showPage ("Accounting_Clients_Invoice_Edit2", nID); 
			});
		},
