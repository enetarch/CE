webapp.pages.Accounting_Clients_Invoice_New =
	{
		...
		pageInit : function ()
		{
			var me = webapp.pages.Accounting_Clients_Invoice_New;
		...
		{ 
			...
			webapp.queryServer ("accounting::clients::invoice::add", szParams, function (objJSON)
			{ 
				var nID = objJSON.return;
				
				webapp.showPage ("Accounting_Clients_Invoice_New2", nID); 
			});
		},
