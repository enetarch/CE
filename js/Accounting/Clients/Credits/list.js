webapp.pages.Accounting_Clients_Credits_List =
{
	szPageURL : "Accounting_Clients_Credits_List",
	...
	template_List : "credit_list_row_template", 
	tblList : "credit_list",
	get_List :  "accounting::clients::credit::list",
	btn_view : "credit_viewmore",

	btn_AddItem : "button_AddItem",
	btn_SortCreditNo : "button_SortCreditNo",
	...
	pageInit : function ()
	{
		var me = webapp.pages.Accounting_Clients_Credits_List;
		...
		$("#" + me.btn_SortCreditNo).click (function () { me.cmdSortInoviceNo (); } );
	...
	cmdAddItem : function ()
	{ webapp.showPage ("Accounting_Clients_Credit_New"); },
	...
	{	webapp.showPage ("Accounting_Clients_Credit_View", nID); }
};
