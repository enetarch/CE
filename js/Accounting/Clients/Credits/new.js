webapp.pages.Accounting_Clients_Credit_New =
	{
		...
		pageInit : function ()
		{
			var me = webapp.pages.Accounting_Clients_Credit_New;
		...
		{ 
			...
			webapp.queryServer ("accounting::clients::credit::add", szParams, function (objJSON)
			{ 
				var nID = objJSON.return;
				
				webapp.showPage ("Accounting_Clients_Credit_New2", nID); 
			});
		},
