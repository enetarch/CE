webapp.pages.Accounting_Clients_Credit_Edit =
	{
		...
		pageInit : function ()
		{
			var me = webapp.pages.Accounting_Clients_Credit_Edit;
		...
		{ 
			...
			webapp.queryServer ("accounting::clients::credit::update", szParams, function (objJSON)
			{ 
				var nID = objJSON.return;
				
				webapp.showPage ("Accounting_Clients_Credit_Edit2", nID); 
			});
		},
