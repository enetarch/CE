webapp.pages.Accounting_Clients_Returns_List =
{
	szPageURL : "Accounting_Clients_Returns_List",
	...
	template_List : "return_list_row_template", 
	tblList : "return_list",
	get_List :  "accounting::clients::return::list",
	btn_view : "return_viewmore",

	btn_AddItem : "button_AddItem",
	btn_SortReturnNo : "button_SortReturnNo",
	...
	pageInit : function ()
	{
		var me = webapp.pages.Accounting_Clients_Returns_List;
		...
		$("#" + me.btn_SortReturnNo).click (function () { me.cmdSortInoviceNo (); } );
	...
	cmdAddItem : function ()
	{ webapp.showPage ("Accounting_Clients_Return_New"); },
	...
	{	webapp.showPage ("Accounting_Clients_Return_View", nID); }
};
