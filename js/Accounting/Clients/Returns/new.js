webapp.pages.Accounting_Clients_Return_New =
	{
		...
		pageInit : function ()
		{
			var me = webapp.pages.Accounting_Clients_Return_New;
		...
		{ 
			...
			webapp.queryServer ("accounting::clients::return::add", szParams, function (objJSON)
			{ 
				var nID = objJSON.return;
				
				webapp.showPage ("Accounting_Clients_Return_New2", nID); 
			});
		},
