webapp.pages.Accounting_Clients_Order_New =
	{
		...
		pageInit : function ()
		{
			var me = webapp.pages.Accounting_Clients_Order_New;
		...
		{ 
			...
			webapp.queryServer ("accounting::clients::order::add", szParams, function (objJSON)
			{ 
				var nID = objJSON.return;
				
				webapp.showPage ("Accounting_Clients_Order_New2", nID); 
			});
		},
