webapp.pages.Accounting_Clients_Order_Edit =
	{
		...
		pageInit : function ()
		{
			var me = webapp.pages.Accounting_Clients_Order_Edit;
		...
		{ 
			...
			webapp.queryServer ("accounting::clients::order::update", szParams, function (objJSON)
			{ 
				var nID = objJSON.return;
				
				webapp.showPage ("Accounting_Clients_Order_Edit2", nID); 
			});
		},
