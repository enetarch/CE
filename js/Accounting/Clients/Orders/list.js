webapp.pages.Accounting_Clients_Orders_List =
{
	szPageURL : "Accounting_Clients_Orders_List",
	...
	template_List : "order_list_row_template", 
	tblList : "order_list",
	get_List :  "accounting::clients::order::list",
	btn_view : "order_viewmore",

	btn_AddItem : "button_AddItem",
	btn_SortOrderNo : "button_SortOrderNo",
	...
	pageInit : function ()
	{
		var me = webapp.pages.Accounting_Clients_Orders_List;
		...
		$("#" + me.btn_SortOrderNo).click (function () { me.cmdSortInoviceNo (); } );
	...
	cmdAddItem : function ()
	{ webapp.showPage ("Accounting_Clients_Order_New"); },
	...
	{	webapp.showPage ("Accounting_Clients_Order_View", nID); }
};
