webapp.pages.Accounting_Clients_Quote_Edit =
	{
		...
		pageInit : function ()
		{
			var me = webapp.pages.Accounting_Clients_Quote_Edit;
		...
		{ 
			...
			webapp.queryServer ("accounting::clients::quote::update", szParams, function (objJSON)
			{ 
				var nID = objJSON.return;
				
				webapp.showPage ("Accounting_Clients_Quote_Edit2", nID); 
			});
		},
