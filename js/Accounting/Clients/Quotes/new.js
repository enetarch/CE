webapp.pages.Accounting_Clients_Quote_New =
	{
		...
		pageInit : function ()
		{
			var me = webapp.pages.Accounting_Clients_Quote_New;
		...
		{ 
			...
			webapp.queryServer ("accounting::clients::quote::add", szParams, function (objJSON)
			{ 
				var nID = objJSON.return;
				
				webapp.showPage ("Accounting_Clients_Quote_New2", nID); 
			});
		},
