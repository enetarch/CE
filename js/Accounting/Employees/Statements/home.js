webapp.pages.Accounting_Employees_Statements_Home =
{
	buttons : 
	{
		 ...
		 { 	
				var me = webapp.pages.Accounting_Employees_Statements_Home;
	...
	list : 
	{
		...
		row :
		{
			...
			get_Data : "accounting::employees::statements::list",
		},
