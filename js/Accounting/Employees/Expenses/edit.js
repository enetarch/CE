webapp.pages.Accounting_Employees_Expense_Edit =
{
	buttons : 
	{
		...
		{ 
			var me = webapp.pages.Accounting_Employees_Expense_Edit;	
	...
	data_expenses_header : 
	{
		...
		buttons : {},
		get_Data : "accounting::employees::po::get",
		params : { nID : 123 },
	},
	...
	list_expenses_detail : 
	{
		...
		row :
		{
			...
			{ 
				...
				{ webapp.showPage ("Accounting_Employees_Expense_Edit", nID);}, 
			},
		...
		footer : 
		{
			...
			buttons : {},
			get_Data : "accounting::employees::expenses::get",
		},
