...
<script src="js/DayTimer/Todos/edit.js"></script>

<body>
<div id="titlebar" class="titlebar">
	<div id="titlebar_back" class="titlebar_back"></div>
	<div id="titlebar_logo" class="titlebar_logo"></div>
	<div id="titlebar_name" class="titlebar_name">Edit Todo</div>
...
<div id="data_panel" class="data_panel">
	...
	<table id="todo_new" class="table_width">
	</table>

	</div>
</div>

<script id="todo_new_template" type="text/text">
	<tr>
