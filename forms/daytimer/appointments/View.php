...
<script src="js/DayTimer/Appointments/view.js"></script>

<body>
<div id="titlebar" class="titlebar">
	<div id="titlebar_back" class="titlebar_back"></div>
	<div id="titlebar_logo" class="titlebar_logo"></div>
	<div id="titlebar_name" class="titlebar_name">View Appointment</div>
...
<div id="data_panel" class="data_panel">
	...
	<table id="appointment_new" class="table_width">
	</table>

	</div>
</div>

<script id="appointment_new_template" type="text/text">
	<tr>
