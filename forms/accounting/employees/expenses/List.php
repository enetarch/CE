...
<script src="js/Accounting/Employees/Expenses/list.js" ></script>
...
<div id="options_panel" class="row_vcenter options_panel background_Solid">
	...
	<div id="button_SortByExpenseNo" class="row_vcenter blank_row background_Solid">
...
<script id="fees_list_row_template" type="text/text">
	...
	<tr>
		<td colspan="4"><span id="memo" class="">[?= szMemo ?]</span></td> 
	</tr>
</script>
