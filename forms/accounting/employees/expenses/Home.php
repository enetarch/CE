...
<script src="js/Accounting/Employees/Expenses/home.js" ></script>

<body>
<div id="titlebar" class="titlebar">
	<div id="titlebar_back" class="titlebar_back"></div>
	<div id="titlebar_logo" class="titlebar_logo"></div>
	<div id="titlebar_name" class="titlebar_name">Expenses</div>
...
<div id="options_panel" class="row_vcenter options_panel background_Solid">
	...
	<div id="button_AddItem" class="blank_row background_Solid">
		...
		<div id="" class="form_label_text">Add a New Expense </div>
	</div>
	...
	<div id="button_SortByInvoiceNo" class="row_vcenter blank_row background_Solid">
		...
		<div id="" class="form_label_text">Sort by Expense ID</div>
	</div>
...
<div id="data_panel" class="data_panel">
	<div id="panel_pos" class="">
		...
		<table id="expense_list" class="list_table" >
		</table>

	</div>
</div>

<script id="expense_list_row_template" type="text/text">
	...
	<tr>
		...
		<td rowspan ="2" id="moreinfo">
			<div id="expense_viewmore_[?= t ?]" class="list_viewmore" value="[?= ID ?]"></div>
		</td>
	</tr>
	<tr>
