...
<script src="js/Accounting/Employees/PayChecks/new.js" ></script>

<body>
<div id="titlebar" class="titlebar">
	<div id="titlebar_back" class="titlebar_back"></div>
	<div id="titlebar_logo" class="titlebar_logo"></div>
	<div id="titlebar_name" class="titlebar_name">New PayCheck</div>
...
<div id="data_panel" class="data_panel">
	<div id="panel_payment" class="">
		...
		<div id="row" class="form_row">
			...
			<div id="button_view_[?= t ?]" class="buttonbar_viewmore buttonbar_button buttonbar_float_right" value="[?= t ?]"></div>
		</div>
