<html>
<head>
<title>Inventory Catagories</title>
</head>
<script src="js/Accounting/Inventory/Catagories/list.js" ></script>

<body>
<div id="titlebar" class="titlebar">
	<div id="titlebar_back" class="titlebar_back"></div>
	<div id="titlebar_logo" class="titlebar_logo"></div>
	<div id="titlebar_name" class="titlebar_name">Inventory Catagories</div>
...
<div id="data_panel" class="data_panel">
	<div id="panel_Inventory_Catagories" class="">
...
<table id="Inventory_Catagories_list" class="list_table">
</table>

<script id="Inventory_Catagories_list_row_template" type="text/text">
	...
	<tr>
		<td><span id="product_description" class="">[?= szDescription ?]</span></td> 
	</tr>
</script>
