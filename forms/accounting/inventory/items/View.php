...
<script src="js/Accounting/Inventory/Items/view.js" ></script>
	...
	<div id="panel_register" class="">
		...
		<div id="row" class="">
			...
			<div id="" class="form_field_column ">
				<span id="field_szName" class="form_field_text">[?= szName ?]</span>
			</div>
		</div>
		<div id="row" class="">
			<div id="label_szDescription" class="form_label_column form_label_text">Description</div>
			<div id="" class="form_field_column ">
				<span id="field_szDescription" class="form_field_text">[?= szDescription ?]</span>
			</div>
		</div>
		<div id="row" class="">
			<div id="label_szPartNo" class="form_label_column form_label_text">Part No</div>
			<div id="" class="form_field_column ">
				<span id="field_szPartNo" class="form_field_text">[?= szPartNo ?]</span>
			</div>
		</div>
		<div id="row" class="">
		...
		<div id="row" class="">
			...
			<div id="" class="form_field_column ">
				<span id="field_nPrice" class="form_field_text">[?= nPrice ?]</span>
			</div>
		</div>
		<div id="row" class="">
			<div id="label_bTax" class="form_label_column form_label_text">Taxable</div>
			<div id="" class="form_field_column ">
				<span id="field_bTax" class="form_field_text">[?= bTax ?]</span>
			</div>
		</div>
