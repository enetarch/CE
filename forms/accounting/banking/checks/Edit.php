...
<script src="js/Accounting/Banking/Checks/edit.js" ></script>

<body>
<div id="titlebar" class="titlebar">
	<div id="titlebar_back" class="titlebar_back"></div>
	<div id="titlebar_logo" class="titlebar_logo"></div>
	<div id="titlebar_name" class="titlebar_name">Edit Check</div>
...
<script id="new_check_template" type="text/text">
		<div id="row" class="form_row">
			<div id="label_no" class="form_label_column form_label_text">Check No</div>
