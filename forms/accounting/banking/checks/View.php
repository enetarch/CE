...
<script src="js/Accounting/Banking/Checks/view.js" ></script>

<body>
<div id="titlebar" class="titlebar">
	<div id="titlebar_back" class="titlebar_back"></div>
	<div id="titlebar_logo" class="titlebar_logo"></div>
	<div id="titlebar_name" class="titlebar_name">Check</div>
...
<div id="data_panel" class="data_panel">
	...
	<div id="panel_view_check" class="">
	</div>

<script id="view_check_template" type="text/text">
