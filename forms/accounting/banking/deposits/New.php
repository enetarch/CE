...
<div id="titlebar" class="titlebar">
	...
	<div id="titlebar_name" class="titlebar_name">New Deposit</div>
...
<script id="checks_list_row_template" type="text/text">
	...
	<tr>
		...
		<td rowspan ="2" id="moreinfo">
			<div id="button_check_remove_[?= t ?]" class="buttonbar_delete buttonbar_button buttonbar_float_right" value="[?= ID ?]"></div>
		</td>
	</tr>
	<tr>
