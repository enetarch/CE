...
<script src="js/Accounting/Banking/Statements/home.js" ></script>

<body>
<div id="titlebar" class="titlebar">
	<div id="titlebar_back" class="titlebar_back"></div>
	<div id="titlebar_logo" class="titlebar_logo"></div>
	<div id="titlebar_name" class="titlebar_name">Bank Balances</div>
...
<div id="data_panel" class="data_panel">
	<div id="panel_bank_balances" class="">
...
<script id="statement_detail_list_header_template" type="text/text">
	...
	<tr>
		...
		<td><span id="field_client" class="">Bank</span></td> 
...
<script id="statement_detail_list_row_template" type="text/text">
	...
	<tr>
		...
		<td><span id="field_client" class="">[?= szBank ?]</span></td> 
		<td class="form_text_align_right"><span id="field_amount" class="">[?= nAmount ?]</span></td> 
		<td><div id="bank_viewmore_[?= t ?]" class="buttonbar_viewmore buttonbar_button" value="[?= t ?]"></div></td> 
	</tr>
	<tr>
	</tr>
</script>
