...
<script src="js/Accounting/Banking/list.js" ></script>

<body>
<div id="titlebar" class="titlebar">
	<div id="titlebar_back" class="titlebar_back"></div>
	<div id="titlebar_logo" class="titlebar_logo"></div>
	<div id="titlebar_name" class="titlebar_name">Bank List</div>
...
<div id="options_panel" class="row_vcenter options_panel background_Solid">
	...
	<div id="button_AddBank" class="blank_row background_Solid">
		<div id="button_Add" class="buttonbar_add buttonbar_button"></div>
		<div id="" class="form_label_text">Add a New Bank</div>
	</div>
...
<table id="bank_list" class="list_table">
</table>

<script id="bank_list_row_template" type="text/text">
	...
	<tr>
		...
		<td rowspan ="2" id="moreinfo">
			<div id="bank_viewmore_[?= t ?]" class="list_viewmore" value="[?= nID ?]"></div>
		</td>
	</tr>
	<tr></tr>
</script>
