...
<script src="js/Accounting/Vendors/Quotes/edit.js" ></script>

<body>
<div id="titlebar" class="titlebar">
	<div id="titlebar_back" class="titlebar_back"></div>
	<div id="titlebar_logo" class="titlebar_logo"></div>
	<div id="titlebar_name" class="titlebar_name">Quote Header</div>

	<div id="titlebar_exit" class="titlebar_exit"></div>
</div>

<div id="Vendors_panel_background" class="options_panel_background background_75pct">
<div id="Vendors_panel" class="row_vcenter options_panel background_Solid">
	
	<div id="button_AddItem" class="blank_row background_Solid">
		<div id="button_Add" class="buttonbar_add buttonbar_button"></div>
		<div id="" class="form_label_text">Add a New Invoice </div>
	</div>
	
	<div id="button_SortByInvoiceNo" class="row_vcenter blank_row background_Solid">
		<div id="button_Sort_InvoiceNo" class="buttonbar_sort buttonbar_button"></div>
		<div id="" class="form_label_text">Sort by Invoice ID</div>
	</div>
...
<div id="data_panel" class="data_panel">
	<div id="panel_quote" class="">
		...
		<div id="row" class="form_row">
			...
			<div id="Vendor_viewmore_[?= t ?]" class="list_viewmore" value="[?= ID ?]"></div>
		</div>
		...
		<div id="row" class="form_row">
			...
			<div id="Vendor_viewmore_[?= t ?]" class="buttonbar_calendar buttonbar_button buttonbar_float_right" value="[?= ID ?]"></div>
		</div>
		...
		<div id="row" class="form_row">
			...
			<div id="Vendor_viewmore_[?= t ?]" class="buttonbar_Payment buttonbar_button buttonbar_float_right" value="[?= ID ?]"></div>
		</div>
		...
		<div id="row" class="form_row">
			...
			<div id="Vendor_viewmore_[?= t ?]" class="buttonbar_button buttonbar_float_right" value="[?= ID ?]"></div>
		</div>
		...
		<div id="row" class="form_row">
			...
			<div id="Vendor_viewmore_[?= t ?]" class="buttonbar_truck buttonbar_button buttonbar_float_right" value="[?= ID ?]"></div>
		</div>
