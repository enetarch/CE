...
<script src="js/Accounting/Vendors/Payments/home.js" ></script>

<body>
<div id="titlebar" class="titlebar">
	<div id="titlebar_back" class="titlebar_back"></div>
	<div id="titlebar_logo" class="titlebar_logo"></div>
	<div id="titlebar_name" class="titlebar_name">Payments</div>
...
<div id="options_panel" class="row_vcenter options_panel background_Solid">
	...
	<div id="button_AddItem" class="blank_row background_Solid">
		...
		<div id="" class="form_label_text">Add a New Payment </div>
	</div>
	...
	<div id="button_SortByInvoiceNo" class="row_vcenter blank_row background_Solid">
		...
		<div id="" class="form_label_text">Sort by Payment ID</div>
	</div>
...
<table id="payments_list" class="list_table" >
</table>

<script id="payments_list_row_template" type="text/text">
	...
	<tr>
		...
		<td rowspan ="2" id="moreinfo">
			<div id="payment_viewmore_[?= t ?]" class="list_viewmore" value="[?= ID ?]"></div>
		</td>
	</tr>
	<tr>
