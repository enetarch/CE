...
<script src="js/Accounting/Vendors/POs/edit.js" ></script>

<body>
<div id="titlebar" class="titlebar">
	<div id="titlebar_back" class="titlebar_back"></div>
	<div id="titlebar_logo" class="titlebar_logo"></div>
	<div id="titlebar_name" class="titlebar_name">Edit PO</div>
...
<div id="data_panel" class="data_panel">
	<div id="panel_po" class="">
		...
		<table id="po_detail_list" class="list_table">
		</table>
...
<script id="po_header_template" type="text/text">
		<div id="row" class="form_row">
...
<script id="po_detail_list_header_template" type="text/text">
...
<script id="po_detail_list_row_template" type="text/text">
	<tr class="list_seperator_line"><td colspan="6"><!-- Seperator Line --></td></tr>
	<tr>
		...
		<td rowspan ="2" id="moreinfo">
			<div id="button_Delete_[?= t ?]" class="buttonbar_delete buttonbar_button buttonbar_float_right " value="[?= nID ?]"></div>
		</td>
...
<script id="po_detail_list_empty_row_template" type="text/text">
...
<script id="po_detail_list_footer_template" type="text/text">
...
<script id="po_notes_template" type="text/text">
		<div id="row" class="form_row">
			<div id="blank_row" class="">&nbsp;</div>
		</div>
