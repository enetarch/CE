...
<script src="js/Accounting/Vendors/Reimbursements/view.js" ></script>

<body>
<div id="titlebar" class="titlebar">
	<div id="titlebar_back" class="titlebar_back"></div>
	<div id="titlebar_logo" class="titlebar_logo"></div>
	<div id="titlebar_name" class="titlebar_name">Reimbursement</div>
...
<div id="data_panel" class="data_panel">
	...
	<div id="panel_view_reimbursement" class="">
	</div>

<script id="view_reimbursement_template" type="text/text">
		...
		<div id="row" class="form_row">
			<div id="label_Vendor" class="form_label_column form_label_text">No</div>
			<div id="field_Vendor" class="form_field_column form_label_text">[?= nID ?]</div>
		</div>
		...
		<div id="row" class="form_row">
			<div id="label_VendorNotes" class="form_label_column form_label_text">To</div>
			<div id="field_VendorNotes" class="form_field_column form_label_text">[?= szTo ?]</div>
		</div>
