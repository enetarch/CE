...
<script src="js/Accounting/Clients/Invoices/view.js" ></script>

<body>
<div id="titlebar" class="titlebar">
	<div id="titlebar_back" class="titlebar_back"></div>
	<div id="titlebar_logo" class="titlebar_logo"></div>
	<div id="titlebar_name" class="titlebar_name">View Invoice</div>
...
<table id="invoice_detail_list" class="list_table">
</table>
...
<script id="invoice_header_template" type="text/text">
...
<script id="invoice_detail_list_header_template" type="text/text">
...
<script id="invoice_detail_list_row_template" type="text/text">
	<tr class="list_seperator_line"><td colspan="6"><!-- Seperator Line --></td></tr>
	<tr>
...
<script id="invoice_detail_list_footer_template" type="text/text">
...
<script id="invoice_detail_list_empty_row_template" type="text/text">
...
<script id="invoice_notes_template" type="text/text">
		<div id="row" class="form_row">
			<div id="blank_row" class="">&nbsp;</div>
		</div>
