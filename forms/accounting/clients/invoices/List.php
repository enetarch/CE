...
<script src="js/Accounting/Clients/Invoices/list.js" ></script>
...
<table id="invoice_list" class="list_table">
</table>

<script id="invoice_list_row_template" type="text/text">
	<tr class="list_seperator_line"><td colspan="5"><!-- Seperator Line --></td></tr>
	<tr>
		<td><span id="invoice_no" class="">[?= szInvoiceNo ?]</span></td> 
