...
<script src="js/Accounting/Clients/Orders/list.js" ></script>

<body>
<div id="titlebar" class="titlebar">
	<div id="titlebar_back" class="titlebar_back"></div>
	<div id="titlebar_logo" class="titlebar_logo"></div>
	<div id="titlebar_name" class="titlebar_name">Order List</div>
...
<table id="order_list" class="list_table">
</table>

<script id="order_list_row_template" type="text/text">
	<tr class="list_seperator_line"><td colspan="5"><!-- Seperator Line --></td></tr>
	<tr>
		<td><span id="order_no" class="">[?= szInvoiceNo ?]</span></td> 
		...
		<td rowspan ="2" id="moreinfo">
			<div id="order_viewmore_[?= t ?]" class="list_viewmore" value="[?= ID ?]"></div>
		</td>
	</tr>
	<tr>
