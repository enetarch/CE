...
<script src="js/Accounting/Clients/Returns/view.js" ></script>
...
<table id="return_detail_list" class="list_table">
</table>
...
<script id="return_detail_list_header_template" type="text/text">
...
<script id="return_detail_list_row_template" type="text/text">
	<tr class="list_seperator_line"><td colspan="6"><!-- Seperator Line --></td></tr>
	<tr>
...
<script id="return_detail_list_footer_template" type="text/text">
...
<script id="return_detail_list_empty_row_template" type="text/text">
