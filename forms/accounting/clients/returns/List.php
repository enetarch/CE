...
<script src="js/Accounting/Clients/Returns/list.js" ></script>

<body>
<div id="titlebar" class="titlebar">
	<div id="titlebar_back" class="titlebar_back"></div>
	<div id="titlebar_logo" class="titlebar_logo"></div>
	<div id="titlebar_name" class="titlebar_name">Return List</div>
...
<div id="options_panel" class="row_vcenter options_panel background_Solid">
	...
	<div id="button_SortByReturnNo" class="row_vcenter blank_row background_Solid">
		<div id="button_Sort_ReturnNo" class="buttonbar_sort buttonbar_button buttonbar_float_left"></div>
...
<table id="return_list" class="list_table">
</table>

<script id="return_list_row_template" type="text/text">
	<tr class="list_seperator_line"><td colspan="5"><!-- Seperator Line --></td></tr>
	<tr>
		<td><span id="return_no" class="">[?= szReturnNo ?]</span></td> 
		...
		<td rowspan ="2" id="moreinfo">
			<div id="return_viewmore_[?= t ?]" class="list_viewmore" value="[?= ID ?]"></div>
		</td>
	</tr>
	<tr>
