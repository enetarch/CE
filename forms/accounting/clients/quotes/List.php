...
<script src="js/Accounting/Clients/Quotes/list.js" ></script>

<body>
<div id="titlebar" class="titlebar">
	<div id="titlebar_back" class="titlebar_back"></div>
	<div id="titlebar_logo" class="titlebar_logo"></div>
	<div id="titlebar_name" class="titlebar_name">Invoice List</div>
...
<table id="quote_list" class="list_table">
</table>

<script id="quote_list_row_template" type="text/text">
	<tr class="list_seperator_line"><td colspan="5"><!-- Seperator Line --></td></tr>
	<tr>
		<td><span id="quote_no" class="">[?= szInvoiceNo ?]</span></td> 
		...
		<td rowspan ="2" id="moreinfo">
			<div id="quote_viewmore_[?= t ?]" class="list_viewmore" value="[?= ID ?]"></div>
		</td>
	</tr>
	<tr>
