...
<script src="js/Accounting/Clients/Credits/edit.js" ></script>

<body>
<div id="titlebar" class="titlebar">
	<div id="titlebar_back" class="titlebar_back"></div>
	<div id="titlebar_logo" class="titlebar_logo"></div>
	<div id="titlebar_name" class="titlebar_name">Credit Header</div>
...
<div id="clients_panel" class="row_vcenter options_panel background_Solid">
	...
	<div id="button_SortByCreditNo" class="row_vcenter blank_row background_Solid">
		<div id="button_Sort_CreditNo" class="buttonbar_sort buttonbar_button"></div>
