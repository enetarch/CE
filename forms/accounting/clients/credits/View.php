...
<script src="js/Accounting/Clients/Credits/view.js" ></script>
...
<table id="credit_detail_list" class="list_table">
</table>
...
<script id="credit_detail_list_header_template" type="text/text">
...
<script id="credit_detail_list_row_template" type="text/text">
	<tr class="list_seperator_line"><td colspan="6"><!-- Seperator Line --></td></tr>
	<tr>
...
<script id="credit_detail_list_footer_template" type="text/text">
...
<script id="credit_detail_list_empty_row_template" type="text/text">
