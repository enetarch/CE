...
<script src="js/Accounting/Clients/Statements/client.js" ></script>

<body>
<div id="titlebar" class="titlebar">
	<div id="titlebar_back" class="titlebar_back"></div>
	<div id="titlebar_logo" class="titlebar_logo"></div>
	<div id="titlebar_name" class="titlebar_name">Client Statement</div>
...
<script id="statement_detail_list_header_template" type="text/text">
	...
	<tr>
		...
		<td><span id="field_client" class="">Memo</span></td> 
...
<script id="statement_detail_list_row_template" type="text/text">
	...
	<tr>
		...
		<td><span id="field_client" class="">[?= szMemo ?]</span></td> 
