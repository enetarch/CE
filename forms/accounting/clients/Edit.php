...
<script src="js/Accounting/Clients/edit.js" ></script>

<body>
<div id="titlebar" class="titlebar">
	<div id="titlebar_back" class="titlebar_back"></div>
	<div id="titlebar_logo" class="titlebar_logo"></div>
	<div id="titlebar_name" class="titlebar_name">Edit Client</div>
...
<div id="data_panel" class="data_panel">
	<div id="panel_register" class="">
		...
		<div id="row" class="">
			<div id="label_company" class="form_label_column form_label_text">Company</div>
			<div id="" class="form_field_column ">
				<input id="field_company" type="text" size="15" value="" class="form_field_text">
				</div>
		</div>
		<div id="row" class="">
